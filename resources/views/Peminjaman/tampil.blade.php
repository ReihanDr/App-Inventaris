                ...
                <tbody>
                     @foreach($data as $d)
                        <tr>
                            ...
                            <th>
                              @if($d->statuspeminjaman == 'Dipinjam' && $d->statuspeminjaman !== null)
                              <a href="/validasipengembalian/prosespengembalian/{{ $d->idpeminjaman }}" class='btn btn-success'>Kembalikan</a>
                              @endif
                            </th>
